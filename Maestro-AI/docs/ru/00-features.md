...
| Внешние инструменты | `ExternalInstruments` | `true` | [33-instruments.md](33-instruments.md) |

> **Поддержка GPIO:** Maestro AI поддерживает [52Pi EP-0129 GPIO 40-PIN Hat](https://wiki.52pi.com/index.php?title=EP-0129) для прямого управления контактами через Raspberry Pi. См. [09-hardware.md](09-hardware.md) для схем подключения, вариантов датчиков и API (`SetHeaterPwm`, `SetFanSpeed`, `SetGpioPin`).
