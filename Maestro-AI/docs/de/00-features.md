...
| Externe Instrumente | `ExternalInstruments` | `true` | [33-instruments.md](33-instruments.md) |

> **GPIO-Unterstützung:** Maestro AI unterstützt den [52Pi EP-0129 GPIO 40-PIN Hat](https://wiki.52pi.com/index.php?title=EP-0129) zur direkten Pin-Steuerung über Raspberry Pi. Siehe [09-hardware.md](09-hardware.md) für Schaltpläne, Sensoroptionen und API-Endpunkte (`SetHeaterPwm`, `SetFanSpeed`, `SetGpioPin`).
