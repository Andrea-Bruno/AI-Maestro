...
> **Orange Pi 5 Pro:** die Pin-Zuordnung (BCM → „chip:line") und die Anforderungen (libgpiod, Overlays) stehen in der englischen Anleitung: `docs/en/09-hardware.md` → Abschnitt „GPIO — Orange Pi 5 Pro".
