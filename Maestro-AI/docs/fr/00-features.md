...
| Instruments Externes | `ExternalInstruments` | `true` | [33-instruments.md](33-instruments.md) |

> **Support GPIO:** Maestro AI prend en charge la [52Pi EP-0129 GPIO 40-PIN Hat](https://wiki.52pi.com/index.php?title=EP-0129) pour le contrôle direct des broches via Raspberry Pi. Voir [09-hardware.md](09-hardware.md) pour les schémas de câblage, les options de capteurs et les API (`SetHeaterPwm`, `SetFanSpeed`, `SetGpioPin`).
