...
Maestro AI supports multiple profile formats for exchange with other software.
...
| **Artisan .alog** | `.alog` | ✅ Temperature + metadata | ✅ Full export |
...
The `.alog` format stores time/temperature arrays, phase events, weight/moisture/color measurements, roast UUID, and metadata — compatible with the Artisan desktop application.
