...
| Instrumentos Externos | `ExternalInstruments` | `true` | [33-instruments.md](33-instruments.md) |

> **Soporte GPIO:** Maestro AI soporta la [52Pi EP-0129 GPIO 40-PIN Hat](https://wiki.52pi.com/index.php?title=EP-0129) para control directo de pines via Raspberry Pi. Ver [09-hardware.md](09-hardware.md) para diagramas de cableado, opciones de sensores y API (`SetHeaterPwm`, `SetFanSpeed`, `SetGpioPin`).
